    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="alert alert-default m-b-mb" role="alert">
                    Need an account? Contact the System Administrator.
                </div>

                 <!--FOOTER DIV-->
                <footer class="footer m-b-mt">
                    <div class="container-fluid">
                        <div class="copyright">
                            &copy;
                            <script>
                            document.write(new Date().getFullYear())
                            </script>, <b>Standard Life Sofware Development Team</b>.
                        </div>
                        <!-- your footer here -->
                    </div>
                </footer>
                ...
                <div class="modal-content">
                    <div class="card card-signup card-plain">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title card-title justify-content-center" style="font-weight: bold;" >Sign In to TaskManager</h5>
                        ...
                        <div class="modal-body">
                            <form class="form" method="POST" action="{{ route('login') }}">
                              @csrf
                                <p class="description text-center">Enter Your Login Credentials</p>
                                <div class="card-body">
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                          ...
                                          <input type="number" maxlength="10" class="form-control" placeholder="Staff ID (digits only)..." required autofocus>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer justify-content-center">
                            <a href="/dashboard" class="btn btn-info btn-round btn-wd btn-lg" style="font-weight: bold;">Authenticate</a>
                        </div>
                    </div>
                </div>
            </div>
